...
{
$content1 = Get-Content C:\prakashp\Pre-check-services-2020-03-24\pre_$server.txt
$content2 = Get-Content C:\prakashp\Post-check-services-2020-03-24\post_$server.txt
