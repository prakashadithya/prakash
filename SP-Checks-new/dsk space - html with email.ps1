...
Get-DiskSpaceReport -ComputerList c:\prakash1.txt  -EmailTo: "prakash.adithyap@refinitiv.com"  -EmailFrom: prakash.adithyap@refinitiv.com -SMTPMail: corprelay.int.refinitiv.com